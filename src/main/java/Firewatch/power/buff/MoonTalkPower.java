...
public class MoonTalkPower extends AbstractFirewatchPower {
    public static final String POWER_ID = "firewatch:MoonTalkPower";

    public MoonTalkPower(AbstractCreature owner, int amount) {
